...
public class CustomerController {
	...
	public CustomerDTO getCustomerProfile(@RequestHeader HttpHeaders headers,HttpServletRequest request ,@PathVariable Long phoneNo) {
		logger.info("REQUEST IS ======= {}",request);
		logger.info("HEADERS ===== {}",headers);
		logger.info("Key Set ===== {}",headers.keySet());
		logger.info("User Agent {}",headers.getFirst("user-agent"));
		logger.info("Authorization {}",headers.getFirst("Authorization"));
